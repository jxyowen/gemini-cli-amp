...
import { ApiDefinitionCrudTool } from '../tools/api/api-definition-crud.js';
...
export function createToolRegistry(config: Config): Promise<ToolRegistry> {
  ...
  // Register API lifecycle management tools
  registerCoreTool(ApiDefinitionCrudTool, config);
  return (async () => {
